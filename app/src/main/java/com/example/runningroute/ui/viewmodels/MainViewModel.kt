...
import com.example.runningroute.util.SortType
...
class MainViewModel @Inject constructor(
    ...
    private val runsSortedByDistance = mainRepository.getAllRunsSortedByDistanceM()
    private val runsSortedByCaloriesBurned = mainRepository.getAllRunsSortedByCaloriesBurned()
    private val runsSortedByTime = mainRepository.getAllRunsSortedByTimeMillis()
    ...
    fun deleterRun(run: Run) = viewModelScope.launch {
